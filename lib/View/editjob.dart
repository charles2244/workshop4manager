...
class EditJobPage extends StatelessWidget {
  ...
  const EditJobPage({super.key, required this.controller, required this.work});

  @override
  Widget build(BuildContext context) {
    final TextEditingController descriptionController = TextEditingController(text: work.description);
    int? selectedMechanic = work.mechanicId;
                        ...
                        return FutureBuilder<List<bool>>(
                          ...
                          builder: (context, availabilitySnapshot) {
                            ...
                            return DropdownButtonFormField<int>(
                              ...
                              hint: Text(work.mechanicName ?? "Select Mechanic"),
                        ...
                        onPressed: () async {
                          final confirm = await showDialog<bool>(
                            ...
                            builder: (context) => AlertDialog(
                              ...
                              content: const Text("Are you sure you want to edit this job?"),
                              actions: [
                                TextButton(
